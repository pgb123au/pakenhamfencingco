# Pakenham Fencing &amp; Pergolas — rank-and-rent microsite
...
| Item | Value |
|---|---|
| Domain | `pakenhamfencingco.com.au` (registered, GoDaddy fraud-pending) |
| Live URL (interim) | https://pakenhamfencingco.netlify.app |
...
├── whisper.js                # "Pete's Lead from Pakenham Fencing &amp; Pergolas" played to contractor before patching caller through
...
| `TENANT_BRAND` | `Pakenham Fencing &amp; Pergolas` (default) | What plays after the label — full whisper is `"Pete's Lead. Pete's Lead from Pakenham Fencing &amp; Pergolas."` |
...
3. Submit to Google Search Console (`sc-domain:pakenhamfencingco.com.au`).
4. Set up Google Business Profile (needs registered business name "Pakenham Fencing &amp; Pergolas" first).
