"""Bulk find/replace + page rename for Pakenham Fencing scaffold."""
...
REPLACEMENTS = [
    ("https://geelongroofrestorations.com.au", "https://pakenhamfencingco.com.au"),
    ("geelongroofrestorations.com.au", "pakenhamfencingco.com.au"),
    ("geelongroofrestorations", "pakenhamfencingco"),
    ("Geelong Roof Restorations", "Pakenham Fencing &amp; Pergolas"),
    ...
    ("/services/roof-cleaning/", "/services/rural-acreage-fencing/"),
    ("/services/roof-painting/", "/services/timber-paling-fencing/"),
    ("/services/tile-restoration/", "/services/gates-automation/"),
    ("/services/metal-restoration/", "/services/colorbond-fencing/"),
    ("/services/gutter-replacement/", "/services/pool-safety-fencing/"),
    ("/newtown/", "/officer/"),
    ...
    ("Armstrong Creek", "Heritage Springs"),
    ("Lara", "Beaconsfield"),
    ("quotes@geelongroofrestorations.com.au", "quotes@pakenhamfencingco.com.au"),
    (">G</text>", ">P</text>"),
]
...
def main():
    ...
    if pkg.exists():
        ...
        s = s.replace('"name": "geelongroofrestorations"', '"name": "pakenhamfencingco"')
